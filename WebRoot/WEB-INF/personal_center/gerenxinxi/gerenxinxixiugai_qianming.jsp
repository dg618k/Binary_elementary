...
<html>
  <head>
    ...
    <title>My JSP 'gerenxinxixiugai_qianming.jsp' starting page</title>
	...
	<link rel="stylesheet" type="text/css" href="css/gerenxinxixiugai.css"></link>
  </head>
  ...
  <div class="mod-setting clearfix">
   ...
   <h3>个人资料</h3>
     ...
     <ul class="menu-list">
      ...
      <a href="personal_center/gerenxinxixiugaiview" >昵称</a></li>
      
       <li class="menu-split"> </li>
       <li class="menu-item basic-link on">
       <a href="personal_center/gerenxinxixiugai_qianmingview" >个性签名</a> </li>
       
       <li class="menu-split">  </li>
       <li class="menu-item portrait-link">
       <a href="personal_center/gerenxinxixiugai_touxiangview">头像</a> </li>
       </ul> 
       <div class="menu-title menu-privacy" id="settingPrivacy"> 
       <h3>资料修改</h3> </div> 
       <ul class="menu-list"> 
       <li class="menu-item tieba-link" id="settingPrivacyTieba">
       <a href="personal_center/nichengxiugaiview">昵称修改</a> </li>
       <li class="menu-split"> </li>
       <li class="menu-item zhidao-link" id="settingPrivacyZhidao">
       <a href="personal_center/mimaxiugaiview">密码修改</a> </li>
       <li class="menu-split"> </li>
       <li class="menu-item wenku-link" id="settingPrivacyWenku">
       <a href="personal_center/qianmingxiugaiview">签名修改</a>  </li>
       <li class="menu-split"> </li>
       <li class="menu-item baike-link" id="settingPrivacyBaike">
       <a href="personal_center/touxiangxiugaiview">头像修改</a> </li>
       <li class="menu-split"> </li>
       </ul> </div>
        <div class="setting-detail" id="stthld" style="display: block;">
         ...
         <div class="setting-profile-title yahei">个性签名</div>
          <form class="setting-profile-form" id="profile" action="https://passport.baidu.com/v2/?ucenterset" method="POST">
           ...
           <tbody> 
              ...
              <iframe width="0" height="0" class="setting-proxy" id="proxy" src="stthld"></iframe></div></div> </div> </div> </div> </div>
