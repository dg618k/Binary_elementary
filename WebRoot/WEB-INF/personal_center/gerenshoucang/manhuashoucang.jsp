      ...
      <a id="close-browser-tip" href="javascript:;"></a>
		   ...
		   <div class="nav-title">
		    <span class="text">视频收藏</span> 
		     ...
		     <div class="fav-list-container"> 
		      ...
		      <a title="视频收藏夹" class="text v-link-active" href="personal_center/shipinshoucang">视频收藏夹</a> 
		 ...
		 <div class="fav-list-container"> 
		    ...
		    <span class="icon icon-fav-private"></span>
		     <a class="text v-link-active" href="personal_center/manhuashoucang">漫画收藏夹</a>
		    </li> </ul> </div> </div> </div>
		   <div class="fav-main"> 
		    <div class="fav-header fav-header-info"> 
		   <div class="breadcrumb"> <p class="item cur">漫画收藏夹</p> </div>
		    <div class="fav-info clearfix"> 
		    <div class="fav-meta"> 
		     <span class="type">公开</span>
		      <span class="dot">·</span> 
		     <span class="num">1</span>
		     <span class="num">个漫画</span> </div> 		     
		     ...
		     <div class="tooltip-list" style="display: none;"> 
		      ...
		      <a class="cover" href="" target="_blank">
		       <img alt="火影忍者漫画" src="image/2.jpg">
		      ...
		      <div class="candle" style="visibility: hidden; background-position-x: 0px;"></div>
		       ...
		       <div class="meta-mask"> 
		          ...
		          <a title="火影忍者漫画" class="title" href="//www.bilibili.com/video/av10909840" target="_blank">火影忍者漫画</a> 
